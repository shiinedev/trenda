        ...
        <div className="@container/main py-6 px-4">
            <Card>
                <CardHeader className="text-center">
                    <CardTitle>{product ? "UpdateProduct" : "Create new Product"}</CardTitle>
                    <CardDescription>
                        ...
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                                ...
                                <FormField
                                    ...
                                    render={({ field }) => (
                                        <FormItem>
                                            ...
                                            <FormControl>
                                                <Input type='number' placeholder="Enter product stock quantity" {...field}
                                                    value={field.value}
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        <div
                                            {...getRootProps()}
                                            className={`border-2 border-dashed rounded-xl p-6 text-center cursor-pointer transition ${files.length + existingImages.length >= 5
                                        ...
                                        {files.length + existingImages.length > 0 && (
                                            <FormDescription className="text-xs text-slate-500 mt-2">
                                                {files.length + existingImages.length} of {maxImages} images uploaded
                                            </FormDescription>
                                        )}
                            ...
                            <div className="flex items-center space-x-2">
                                <Button type="submit" className="flex-1" disabled={isSubmitting || isUploading}>
                                    {isSubmitting ? (product ? (isUploading && "updating...") : (isUploading && "Creating...")) : (
                                        product ? "Update Product" : "Create new Product")}
                                </Button>
                                <Button type="button" variant={"outline"} onClick={handelClear}>cancel</Button>
                            </div>
