...
export default function ProductsPage() {
    ...
    const categories = ["Electronics", "Fashion", "Home", "Furniture", "Sports", "Beauty"]
            ...
            <main className="min-h-screen bg-slate-50">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-slate-600">Discover amazing products with AI-powered recommendations</p>
                    </div>
                            ...
                            <div className={viewMode === "grid" ? "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" : " space-y-4"}>
                                {filteredProducts.map((product) => (
                                    <Link href={`/products/${product._id}`} key={product._id}>
                                        <Card className={`group p-0 hover:shadow-xl transition-all duration-300 overflow-hidden ${viewMode === "list" && "mb-4"}`}>
